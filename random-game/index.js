...
console.log("Вроде-бы все требования ТЗ соблюдены, но буду рада, если укажите на ошибки. (Вёрстка, Логика игры, Завершение игры, Результат, Таблица рекордов, Звуки игры - все реализовано). Из дополнительного реализованного функционала: можно менить скорость игры(в настройках), а также поставить игру на play/pause). Правила игры думаю знаете, единственное хочу уточнить, что игра заканчивается в случае, когда змейка врезается в свой хвост.")